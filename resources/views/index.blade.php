    ...
    <div class="tm-main-section light-gray-bg">
        ...
        <section class="tm-section tm-section-margin-bottom-0 row">
            ...
            <div class="tm-popular-item">
                <img src="{{$menu_americano->gambar}}" alt="Popular" class="tm-popular-item-img" style="width: 286px; height: 166px;">
            ...
            <div class="tm-popular-item">
              <img src="{{$menu_cappuccino->gambar}}" alt="Popular" class="tm-popular-item-img" style="width: 286px; height: 166px;">
              <div class="tm-popular-item-description">
            ...
            <div class="tm-popular-item">
              <img src="{{$menu_mocha->gambar}}" alt="Popular" class="tm-popular-item-img" style="width: 286px; height: 166px;">
              <div class="tm-popular-item-description">
          ...
          <div class="col-lg-12 tm-special-container margin-top-60">
            <div class="tm-special-container-left"> <!-- left -->
              <div class="tm-special-item">
                <div class="tm-special-img-container">
                  <img src="{{$menu_salted->gambar}}" alt="Special" class="tm-special-img img-responsive" style="width: 520px; height: 400px;">  
                  <a href="#">
            ...
            <div class="tm-special-container-right"> <!-- right -->
              <div>
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="{{$menu_pavlova->gambar}}" alt="Special" class="img-responsive" style="width: 360px; height: 207px;">  
                    <a href="#">
                      <div class="tm-special-description">
              ...
              <div class="tm-special-container-lower">
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="{{$menu_croissant->gambar}}" alt="Special" class="img-responsive" style="width: 155px; height: 155px;">  
                    <a href="#">
                      <div class="tm-special-description">
                ...
                <div class="tm-special-item">
                  <div class="tm-special-img-container">
                    <img src="{{$menu_aglio->gambar}}" alt="Special" class="img-responsive" style="width: 155px; height: 155px;">  
                    <a href="#">
                      <div class="tm-special-description">
                        <p>{{$menu_aglio->nama}}</p>
                      </div>
